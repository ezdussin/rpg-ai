...
export default {
  ...
  game_context:
    `Considering that it is a fantasy medieval world, and you act as a character exploring the world and interacting with NPCs.
    ...
    **Response format**:
    ...
    Current Location: {characters.main['location']}

    If interacting with an NPC:
    NPC found: [Locate the closest NPC in the map JSON and extract their role and details based on this example: {json.dumps(character)}].
